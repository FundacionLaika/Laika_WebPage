...
class Registro extends React.Component {
  ...
  validate = () => {
    ...
    else if (!this.state.correo.includes("@")) errorCorreo = "Correo invalido";

    if (!this.state.nombre) errorNombre = "Introduzca un nombre";

    if (!this.state.apeido) errorApeido = "Introduzca un apeido";

    if (!this.state.contrasena) errorContrasena = "Introduzca una contrasena";
        ...
        <main className="pa4 black-80">
          <div className="measure">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              <legend className="f1 fw6 ph0 mh0">Registrar Cuenta</legend>

              <div className="mt3">
                <label className="db fw6 lh-copy f6" htmlFor="correo">
                  Correo
                </label>
                <input
              ...
              <div className="mt3">
                <label className="db fw6 lh-copy f6" htmlFor="nombre">
                  Nombre
                </label>
                <input
                  className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100"
              ...
              <div className="mt3">
                <label className="db fw6 lh-copy f6" htmlFor="apeido">
                  Apeido
                </label>
                <input
                  className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100"
              ...
              <div className="mv3">
                <label className="db fw6 lh-copy f6" htmlFor="contrasena">
                  Contrasena
                </label>
                <input
