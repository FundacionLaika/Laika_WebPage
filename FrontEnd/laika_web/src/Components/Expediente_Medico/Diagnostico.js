		...
		return (
			<div>
				...
				<input
					...
					checked={this.state.atropellamiento}
				...
				<input
					...
					name="hemoparasitos"
					value="hemoparasitos"
					checked={this.state.hemoparasitos}
					onChange={this.handleChange}
				/>
